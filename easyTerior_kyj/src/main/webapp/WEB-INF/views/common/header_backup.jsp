...
<body>
<nav class="mb-5 navbar navbar-expand-lg border-bottom border-dark border-5">
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="${ contextPath }/"><img style="width:100px;height:100px;" src="${ contextPath }/resources/images/ET_logo.png" class="rounded mx-auto d-block" alt="logo"></a>
